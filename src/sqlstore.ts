// This code was taken from https://github.com/janKir/bgio-postgres/blob/master/src/postgres.ts (with slight modifications)
// All credit goes to janKir for the initial setup of this adapter

// However, this adapter is intended to be used with any database that supports JSON (through Sequelize)
// as well as including a `persist` option, which stores games on a table on the database forever
// instead of storing active games only. Check out the README for more details.

import { LogEntry, Server, State, StorageAPI } from "boardgame.io";
import { Async } from "boardgame.io/internal";
import { Sequelize, Options, Op } from "sequelize";
import { Match, matchAttributes } from "./entities";

export class SQLStore extends Async {
